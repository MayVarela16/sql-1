...
-- Ejercicio 4: Contar cuántos usuarios saben JavaScript.
 SELECT COUNT(*) AS cantidad_usuarios_javascript FROM test.usuarios_lenguajes WHERE lenguaje = 'JavaScript';
...
SELECT COUNT(DISTINCT edad) AS cantidad_edades_diferentes FROM test.usuarios_lenguajes WHERE lenguaje = 'Java';


-- Ejercicio 9: Seleccionar los usuarios que no saben ningún lenguaje.
SELECT * FROM test.usuarios_lenguajes WHERE lenguaje IS NULL;


-- Ejercicio 10: Encontrar el nombre y edad del usuario más joven.
SELECT nombre, edad FROM test.usuarios_lenguajes WHERE edad = (SELECT MIN(edad) FROM test.usuarios_lenguajes);


-- Ejercicio 11: Seleccionar los usuarios y sus edades ordenados por edad de forma descendente.
SELECT nombre, edad FROM test.usuarios_lenguajes ORDER BY edad DESC;


-- Ejercicio 12: Contar cuántos usuarios tienen más de 28 años.
SELECT COUNT(*) AS cantidad_usuarios_mayor_28 FROM test.usuarios_lenguajes WHERE edad > 28;
...
SELECT COUNT(*) AS cantidad_usuarios_python
FROM test.usuarios_lenguajes
...
SELECT COUNT(*) AS cantidad_usuarios_css
FROM test.usuarios_lenguajes
WHERE edad < 30 AND lenguaje = 'CSS';
...
SELECT COUNT(DISTINCT lenguaje) AS cantidad_lenguajes_diferentes
FROM test.usuarios_lenguajes WHERE edad > 25;


-- Ejercicio 25: Seleccionar los usuarios que tienen exactamente la misma edad.
SELECT edad, GROUP_CONCAT(nombre) AS usuarios_con_la_misma_edad
FROM test.usuarios_lenguajes
GROUP BY edad
HAVING COUNT(*) > 1;
...
SELECT COUNT(*) AS cantidad_usuarios_G
FROM test.usuarios_lenguajes
...
SELECT *
FROM test.usuarios_lenguajes
WHERE lenguaje IS NULL OR lenguaje != 'SQL';
...
SELECT nombre, edad, edad - (SELECT AVG(edad) FROM test.usuarios_lenguajes) AS diferencia_edad
FROM test.usuarios_lenguajes;
...
SELECT nombre, LENGTH(nombre) AS longitud_del_nombre
FROM test.usuarios_lenguajes
WHERE lenguaje IS NOT NULL
...
SELECT nombre, SUM(edad) AS suma_edades
FROM test.usuarios_lenguajes
GROUP BY nombre;
